...
The overall_precip_data dataframe contains monthly information on quantities (in inches) of precipitation in Inner Harbor in Baltimore. It contains `r nrow(wheel_data)`observations. Based on the available data, the total precipitation in 2018 was `r sum(pull(filter(overall_precip_data, year == 2018), total))`. 
