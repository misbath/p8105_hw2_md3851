...
The wheel\_data dataframe contains monthly information on overall amounts of trash collected at specific dumpsters in Inner Harbor in Baltimore. It also includes quantities of individual items found in the trash, such as plastic bottles, grocery bags, and cigarette buds. It contains 344 observations. In 2017, the median number of sports balls found in a dumpster was 8.

The overall\_precip\_data dataframe contains monthly information on quantities (in inches) of precipitation in Inner Harbor in Baltimore. It contains 344 observations. Based on the available data, the total precipitation in 2018 was 23.5 inches.
...
```
    ...
    ##  9  1947 Sept…    15        0      23      51     253        1      23
    ## 10  1947 Octo…    15        0      23      51     253        1      23
    ## # … with 1,381 more rows, and 5 more variables: sen_dem <dbl>,
    ## #   rep_dem <dbl>, president <chr>, close <dbl>, unemployment <dbl>

The pols dataset contains information on the number of national politicians who are democratic or republican on a monthly basis. It contains 822 observations. The snp dataset contains 787 observations of 2 variables related to Standard & Poor’s stock market index (S&P), which is often used as a representative measure of stock market as a whole. The unemp dataset contains montlhly and yearly unemployment percentages and includes822 observations.

These three datasets were pulled together to create the overall\_538\_data dataframe, which provides the information described above for the years 1947, 2015.
